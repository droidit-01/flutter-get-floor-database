    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Student` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `email` TEXT NOT NULL, `percentge` INTEGER NOT NULL)');
  ...
  Stream<List<Student>> getAllStudent() {
    return _queryAdapter.queryListStream('SELECT * FROM Student',
        mapper: (Map<String, Object?> row) => Student(
            ...
            percentge: row['percentge'] as int),
